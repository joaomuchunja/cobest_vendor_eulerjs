...
import 'package:cobes_marketplace_vendor/features/profile/domain/models/withdraw_model.dart';
...
class CustomEditDialogWidgetState extends State<CustomEditDialogWidget> {
  ...
  @override
  void initState() {
     Provider.of<WalletController>(context, listen: false).setDefaultPaymentMethod();
                  ...
                  builder: (context, withdraw,_) {
                    return InkWell(
                      ...
                      onTap: () {
                        ...
                        if(haveBlankTitle && withdraw.methodSelected?.type != 'my_methods') {
