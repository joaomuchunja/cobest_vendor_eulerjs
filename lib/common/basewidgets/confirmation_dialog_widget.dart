...
class ConfirmationDialogWidget extends StatelessWidget {
  ...
  const ConfirmationDialogWidget({Key? key, required this.icon, this.title, this.description, required this.onYesPressed, this.isLogOut = false, this.refund = false, this.note, this.color, this.isLoading = false}) : super(key: key);
