...
class CustomDatePickerWidget extends StatefulWidget {
  ...
  const CustomDatePickerWidget({Key? key, this.title,this.text,this.image, this.fromClearance = false, this.fromVacation = false, this.requiredField = false,this.selectDate, this.borderColor}) : super(key: key);
