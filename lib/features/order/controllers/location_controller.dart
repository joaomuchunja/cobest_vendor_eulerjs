...
import 'package:cobes_marketplace_vendor/features/order/domain/models/place_details_model.dart';
import 'package:cobes_marketplace_vendor/features/order/domain/models/prediction_model.dart';
import 'package:cobes_marketplace_vendor/features/order/domain/services/location_service_interface.dart';
...
class LocationController with ChangeNotifier {
  ...
  Future<Position> setLocation(String? placeID, String? address, GoogleMapController? mapController) async {
    ...
    if(response.response?.statusCode == 200) {
      ...
      latLng = LatLng(placeDetails.location?.latitude ?? 0, placeDetails.location?.longitude ?? 0);
    }
