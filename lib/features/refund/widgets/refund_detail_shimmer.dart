...
class RefundDetailShimmer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final pricingContainerBgColor = isDark
        ? Colors.grey[850]!  // darker than cardColor for dark mode
        : Colors.grey[300]!; // lighter than cardColor for light mode

    // Shimmer colors inside pricing container (contrast with bg color)
    final baseColor = isDark ? Colors.grey[700]! : Colors.grey[350]!;
