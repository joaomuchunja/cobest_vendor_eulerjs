        ...
        child: Consumer<VariationController>(
            ...
            return Consumer<AddProductController>(
              builder: (context, resProvider, child) {
                ...
                if (Provider.of<VariationController>(context, listen: false).attributeList != null &&
                    Provider.of<VariationController>(context, listen: false).attributeList!.isNotEmpty) {
                  if(addColor==0) {
                    addColor++;
                ...
                widget.stockQuantityController!.text = variationController.totalQuantityController.text;
                          ...
                          children: [
                            Padding(
                              ...
                              child: Column(mainAxisSize: MainAxisSize.min, children: [
                                ...
                                AttributeViewWidget(product: widget.product, colorOn: variationController.attributeList![0].active, onlyQuantity: true):const CircularProgressIndicator(),
