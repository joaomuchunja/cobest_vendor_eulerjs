...
import 'package:cobes_marketplace_vendor/features/delivery_man/widgets/delivery_man_info_widget.dart';
...
class _AddNewDeliveryManScreenState extends State<AddNewDeliveryManScreen> with TickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBarWidget(title:  getTranslated(widget.deliveryMan != null ? 'edit_profile' : 'add_delivery_man', context), isBackButtonExist: true),
