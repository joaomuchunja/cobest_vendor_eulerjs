...
import 'package:cobes_marketplace_vendor/common/basewidgets/order_shimmer_widget.dart';
import 'package:cobes_marketplace_vendor/common/basewidgets/paginated_list_view_widget.dart';
import 'package:cobes_marketplace_vendor/features/delivery_man/widgets/delivery_man_collected_cash_card_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Consumer<DeliveryManController>(
        builder: (context, collectedCashController, child) {
          ...
          ) : const NoDataScreen(title: 'no_order_found', padding: EdgeInsets.only(top: 100)) : const OrderShimmerWidget(isEnabled: true);
        }
    );
  }
}
