...
import 'package:cobes_marketplace_vendor/features/auth/widgets/info_field_widget.dart';
import 'package:cobes_marketplace_vendor/features/auth/widgets/register_successfull_dialog_widget.dart';
    ...
    return PopScope(
      ...
      onPopInvokedWithResult: (didPop, result) async {
        ...
        if(_tabController?.index  == 1) {
          ...
          authController.setIndexForTabBar(1);
