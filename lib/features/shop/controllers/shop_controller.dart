...
import 'package:cobes_marketplace_vendor/features/clearance_sale/widgets/show_custom_time_picker.dart';
...
import 'package:cobes_marketplace_vendor/features/shop/domain/models/shop_model.dart';
import 'package:cobes_marketplace_vendor/features/shop/domain/models/vacation_model.dart';
import 'package:cobes_marketplace_vendor/features/shop/domain/models/withdrawal_method_model.dart';
import 'package:cobes_marketplace_vendor/features/shop/domain/services/shop_service_interface.dart';
...
class ShopController extends ChangeNotifier {
  ...
  void clearShopModel({isUpdate = true}) {
    _tinCertificateFile = null;
    _tinExpireDate = null;
    _shopModel = null;
    if(isUpdate) {
