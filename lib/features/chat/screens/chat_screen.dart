...
import 'package:cobes_marketplace_vendor/features/chat/screens/media_viewer_screen.dart';
...
import 'package:cobes_marketplace_vendor/features/chat/widgets/message_bubble_widget.dart';
import 'package:cobes_marketplace_vendor/features/chat/widgets/send_message_widget.dart';
    ...
    return Scaffold(
      body: Consumer<ChatController>(builder: (context, chatController, child) {
        return Column(children: [
          ...
          ) : const SizedBox.shrink()) : Expanded(child: CustomLoaderWidget(height: MediaQuery.of(context).size.height-500)),
