...
import 'package:cobes_marketplace_vendor/features/pos/widgets/extra_discount_and_coupon_dialog_widget.dart';
import 'package:cobes_marketplace_vendor/features/pos/widgets/pos_appbar_widget.dart';
...
import 'package:cobes_marketplace_vendor/features/pos/screens/add_new_customer_screen.dart';
import 'package:cobes_marketplace_vendor/features/pos/screens/customer_search_screen.dart';
import 'package:cobes_marketplace_vendor/features/pos/widgets/cart_pricing_widget.dart';
import 'package:cobes_marketplace_vendor/features/pos/widgets/confirm_purchase_dialog_widget.dart';
import 'package:cobes_marketplace_vendor/features/pos/widgets/coupon_apply_widget.dart';
import 'package:cobes_marketplace_vendor/features/pos/widgets/item_card_widget.dart';
import 'package:cobes_marketplace_vendor/features/pos/widgets/pos_no_product_widget.dart';
import '../../../main.dart';
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              Text(PriceConverter.convertPrice(context,
                                                (double.tryParse(PriceConverter.reverseConvertPriceWithoutSymbol(context, double.tryParse(_paidAmountController.text), removeDecimalPoint: false))! - double.parse(total.toStringAsFixed(2)))),
                                                style: robotoRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color)
                                              ),
                                            ],
                                          ),
