  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(children: [
        ...
        Text(title!, style: robotoRegular.copyWith(color: isTotal? Theme.of(context).textTheme.bodyLarge?.color :
        ...
        Text(amount!, style: robotoRegular.copyWith(color: isTotal? Theme.of(context).textTheme.bodyLarge?.color :
        Theme.of(context).hintColor,fontWeight: isTotal? FontWeight.w700: FontWeight.w500,
            fontSize: isTotal? Dimensions.fontSizeLarge: Dimensions.fontSizeDefault),),
