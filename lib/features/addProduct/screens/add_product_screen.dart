...
import 'package:cobes_marketplace_vendor/features/addProduct/domain/models/edt_product_model.dart';
...
import 'package:cobes_marketplace_vendor/features/addProduct/screens/add_product_next_screen.dart';
import 'package:cobes_marketplace_vendor/features/addProduct/widgets/digital_product_widget.dart';
import 'package:cobes_marketplace_vendor/features/addProduct/widgets/select_category_widget.dart';
import 'package:cobes_marketplace_vendor/features/addProduct/widgets/title_and_description_widget.dart';
                                        ...
                                        child: DropdownButton<int>(
                                          ...
                                          items: brandIds.map((int? value) {
                                            return DropdownMenuItem<int>(
                                              ...
                                              child: Text(
                                                value != 0 ? productController.brandList![(brandIds.indexOf(value)-1)].name! : getTranslated('select_brand', context)!,
