...
import 'package:cobes_marketplace_vendor/features/coupon/widgets/coupon_details_dialog_widget.dart';
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(getTranslated(coupons!.couponType, context)!, style: robotoRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color),),
